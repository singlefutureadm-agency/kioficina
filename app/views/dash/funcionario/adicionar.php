<form method="POST" id="form-funcionario" action="http://localhost/kioficina/public/funcionarios/adicionar" enctype="multipart/form-data" class="container my-5 p-4 bg-light shadow rounded">
    <div class="row">
        <!-- Coluna para imagem -->
        <div class="col-md-4 text-center mb-4">
            <img src="http://localhost/kioficina/public/uploads/sem-foto-servico.png" alt="Sem foto" class="img-fluid border rounded" id="preview-img" style="width: 100%; cursor: pointer;">
